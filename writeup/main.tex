...
% table of areas
\multicolumn{2}{c}{\begin{tabular}{|l|c|c|c|c|}
\hline\textbf{Model}: &  Gaussian Naive Bayes & Multinomial Naive Bayes & K-Neighbors & Random Forest  \\ \hline
\textbf{ROC Area} & 0.500 & 0.501 & 0.818 & 0.801 \\ 
\textbf{P-R Area} & 0.550 & 0.550 & 0.489 & 0.453  \\\hline
\end{tabular}} 
\end{tabular}
